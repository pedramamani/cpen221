...
public class AvlTreeSet {
     ...
     * @throws IllegalStateException If this AvlTreeSet does not contain the integer.
     */
     ...
     * tree is empty.
     *
     * @param value The integer whose presence in this AvlTreeSet is to be tested.
     ...
     * @throws IllegalStateException If this AvlTreeSet is empty.
     */
    public int getMax() {
        if (isEmpty()) {
    ...
    private static class Node {
        ...
        private Node doubleRotateLeft() {
            ...
            Node right = new Node(mRight.getValue(), mRight.getLeft().getRight(),
                    mRight.getRight());
            return new Node(value, left, right);
        }
    }
