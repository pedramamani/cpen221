...
public final class ExpressionParser {
        ...
        private void buildTree(Expression newExpression) {
            if (pendingOperator != null) {
                if (pendingRotation) {
                    ...
                    Expression child = new BinaryNode(pendingOperator,
                            binaryRoot.right, newExpression);
    ...
    private Expression convert(Expression tree) {
        if (tree instanceof BinaryNode) {
            ...
            return builder.createBinaryOperationExpression(binaryNode.operator,
                    convert(binaryNode.left),
                    convert(binaryNode.right));
        } else if (tree instanceof UnaryNode) {
            final UnaryNode unaryNode = (UnaryNode) tree;
            return builder.createUnaryOperationExpression(unaryNode.operator,
