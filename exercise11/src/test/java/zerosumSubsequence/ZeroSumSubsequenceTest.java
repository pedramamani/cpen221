...
public class ZeroSumSubsequenceTest {
    ...
    @Test
    public void test6() {
        assertEquals(3, ZeroSumSubsequence.getMaximumLength(Arrays.asList(-1, -1, 2)));
    }

    @Test
    public void test7() {
        assertEquals(2, ZeroSumSubsequence.getMaximumLength(Arrays.asList(-2, 1, 2)));
    }

    @Test
    public void test8() {
        assertEquals(3, ZeroSumSubsequence.getMaximumLength(Arrays.asList(0, 0, 0)));
    }
}