...
public class DNA {
    ...
    public DNA cutAndSplice(String restrictionEnzyme, int splicePosition, String splicee) {
        ...
        newSeqBuilder.append(seqNoJunk.substring(i));
        return new DNA(newSeqBuilder.toString());

    }

    /**
     * Test whether this DNA equals another DNA
     *
     * @param otherDNA another instance of the DNA class
     * @return true if otherDNA equals this DNA and false otherwise
     */
    public boolean equals(Object otherDNA) {
        if ((otherDNA instanceof DNA) && (((DNA) otherDNA).sequence().equals(this.sequence()))) {
            return true;
        }
        return false;
    }
